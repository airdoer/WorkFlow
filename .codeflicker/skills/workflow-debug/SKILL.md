...
| **前端访问地址** | `http://172.28.200.60:8000/workflow/fullscreen?id=ed49ae30-2324-4c68-87fe-13dd69c5869a` |
...
```
http://172.28.200.60:8000/workflow/fullscreen?id=ed49ae30-2324-4c68-87fe-13dd69c5869a
```
...
```bash
# 本地 curl 检测前端是否可访问
curl -s -o /dev/null -w "%{http_code}" "http://172.28.200.60:8000/workflow/fullscreen?id=ed49ae30-2324-4c68-87fe-13dd69c5869a"
```
...
5. 重新访问：`http://172.28.200.60:8000/workflow/fullscreen?id=ed49ae30-2324-4c68-87fe-13dd69c5869a`

...
| **前端访问地址** | `http://172.28.200.60:8000/workflow/fullscreen?id=testNode` |
...
```
http://172.28.200.60:8000/workflow/fullscreen?id=testNode
```
...
```bash
# 本地 curl 检测前端是否可访问
curl -s -o /dev/null -w "%{http_code}" "http://172.28.200.60:8000/workflow/fullscreen?id=testNode"
```
...
5. 重新访问：`http://172.28.200.60:8000/workflow/fullscreen?id=testNode`
